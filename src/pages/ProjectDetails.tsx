        ...
        <div className={`container ${isMobile ? 'px-4' : ''}`}>
          ...
          <div className={`grid gap-8 ${isMobile ? 'grid-cols-1' : 'lg:grid-cols-3'}`}>
            <div className={isMobile ? 'order-2' : 'lg:col-span-2'}>
              ...
              >
                <h2 className={`font-bold text-gray-900 mb-6 ${isMobile ? 'text-xl' : 'text-2xl'}`}>About This Project</h2>
                <div className={`prose max-w-none text-gray-600 ${isMobile ? 'prose-sm' : 'prose-lg'}`}>
                  <p>{project.description}</p>
                  
                  {project.features && (
                    <>
                      <h3 className={`font-semibold text-gray-900 mt-8 mb-4 ${isMobile ? 'text-lg' : 'text-xl'}`}>Key Features</h3>
                      <ul>
                ...
                <div className="space-y-3">
                  {project.github && (
                    <a
                      ...
                      className="flex items-center justify-center w-full bg-gray-900 text-white py-3 px-4 rounded-none hover:bg-gray-800 transition-colors"
                    >
                  ...
                  {project.demo && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center w-full bg-accent text-primary py-3 px-4 rounded-none hover:bg-yellow-400 transition-colors"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
